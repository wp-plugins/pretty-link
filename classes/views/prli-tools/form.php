...
?>
  ...
  <h4><?php _e('TweetDeck Integration:'); ?></h4>
  <span class="description"><?php _e('Follow the'); ?> <a href="http://support.tweetdeck.com/entries/132632-add-a-custom-url-shortener" target="_blank">TweetDeck Custom URL Instructions</a><?php _e(' and add the following URL to TweetDeck'); ?></span>
  <pre><?php echo $prli_blogurl; ?>/index.php?action=prli_endpoint_url&k=<?php echo $prli_options->bookmarklet_auth; ?>&url=%@</pre>
  </p>
  <h3>Bookmarklet: </h3>
