...
<form name="form1" method="post" action="?page=<?php print PRLI_PLUGIN_NAME ?>/prli-groups.php">
...
<p class="submit">
<input type="submit" name="Submit" value="Create" />&nbsp;or&nbsp;<a href="?page=<?php print PRLI_PLUGIN_NAME ?>/prli-groups.php">Cancel</a>
</p>
