<table class="form-table">
  <tr class="form-field">
    ...
    <br/>
      <span class="setting-description">Enter the URL you want to mask and track. Don't forget to start your url with <code>http://</code> or <code>https://</code>. Example: <code>http://www.yoururl.com</code></span></td>
  </tr>
  <tr>
    ...
    <br/>
    <span class="setting-description">Enter the slug (word trailing your main URL) that will form your pretty link and redirect to the URL above.</span></td>
  </tr>
  <tr class="form-field">
    <td width="75px" valign="top">Title: </td>
    <td><input type="text" name="name" size="75" value="<?php echo $values['name']; ?>" />
    <br/>
      <span class="setting-description">This will act as the title of your Pretty Link. If a name is not entered here then the slug name will be used.</span></td>
  </tr>
  <tr class="form-field">
  ...
  <tr class="form-field">
    <td colspan="2">
      ...
      <br/>
      <span class="setting-description">Select a group for this link.</span>
    </td>
  </tr>
</table>
  ...
  <tr>
    <td valign="top" width="50%">
      ...
      <div class="pane">
        ...
        <div class="toggle_pane setting-description">Select this option if you want to show the Pretty Bar at the top of the page when redirecting to the Target URL.</div>
        <br/>
        <input type="checkbox" name="use_ultra_cloak" <?php echo $values['use_ultra_cloak']; ?>/>&nbsp; Ultra Cloak this Link <a class="toggle">[?]</a>
        <div class="toggle_pane setting-description">When checked, the Target URL will be not be visible even after the redirection. This way, if a Target URL doesn't redirect to a URL you want to show then this will mask it.</div>
      </div>
      <br/>
      <h3>Tracking Options</h3>
      <div class="pane">
        <input type="checkbox" name="track_me" <?php echo $values['track_me']; ?>/>&nbsp; Track this Link <a class="toggle">[?]</a>
        <div class="toggle_pane setting-description">De-select this option if you don't want this link tracked. If de-selected, this link will still redirect to the target URL but hits on it won't be recorded in the database.</div>
        <br/>
        <input type="checkbox" name="track_as_img" <?php echo $values['track_as_img']; ?>/>&nbsp; Track as a Pixel <a class="toggle">[?]</a>
        <div class="toggle_pane setting-description">Select this option if you want this link to behave as a tracking pixel instead of as a link. This option is useful if you want to track the number of times a page or email is opened. If you place your Pretty Link inside an img tag on the page (Example: <code>&lt;img src="<?php echo $prli_blogurl . "/yourslug"; ?>" /&gt;</code>) then the page load will be tracked as a click and then displayed. Note: If this option is selected your Target URL will simply be ignored if there's a value in it.</div>
      </div>
      <br/>
      <h3>SEO Options</h3>
      <div class="pane">
        <input type="checkbox" name="nofollow" <?php echo $values['nofollow']; ?>/>&nbsp; 'Nofollow' this Link <a class="toggle">[?]</a>
        <div class="toggle_pane setting-description">Select this if you want to add a nofollow code to this link. A nofollow will prevent reputable spiders and robots from following or indexing this link.</div>
      </div>
    </td>
    <td valign="top" width="50%">
      <h3>Redirect Type:</h3>
      <ul style="list-style-type: none" class="pane">
        <li>
          ...
          <div class="toggle_pane setting-description">This is the best option if you're planning on changing your Target URL and want accurate reporting for this link.</div>
        </li>
        <li>
          <input type="radio" name="redirect_type" value="301" <?php echo $values['redirect_type']['301']; ?> />&nbsp;Permanent Redirect (301) <a class="toggle">[?]</a>
          <div class="toggle_pane setting-description">This is the best option if you're <strong>NOT</strong> planning on changing your Target URL. Traditionally this option is considered to be the best approach to use for your SEO/SEM efforts but since Pretty Link uses your domain name either way this notion isn't necessarily true for Pretty Links. Also, this option may not give you accurate reporting since proxy and caching servers may go directly to your Target URL once it's cached.</div>
        </li>
      </ul>
      <br/>
      <h3>Group Options</h3>
      ...
      <ul style="list-style-type: none" class="pane">
        <li>
          ...
          <div class="toggle_pane setting-description">You may want to leave this option off if you don't need to forward any parameters on to your Target URL.</div>
        </li>
        <li>
          ...
          <div class="toggle_pane setting-description">Select this option if you want to forward parameters through your pretty link to your Target URL. This will allow you to pass parameters in the standard syntax for example the pretty link <code>http://yoururl.com/coollink?product_id=4&sku=5441</code> will forward to the target URL and append the same parameters like so: <code>http://anotherurl.com?product_id=4&sku=5441</code>.</div>
        </li>
        <li>
