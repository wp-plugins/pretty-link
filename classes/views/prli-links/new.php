...
<table class="form-table">
  ...
  <tr>
    <td colspan="2">
      ...
      <ul style="list-style-type: none">
      <li>
        <input type="radio" name="redirect_type" value="307" <?php print ((!isset($_POST['redirect_type']) or (isset($_POST['redirect_type']) and $_POST['redirect_type'] == '307'))?'checked="true"':''); ?>/>&nbsp;Temporary Redirect (307)
      ...
      <li>
        <input type="radio" name="redirect_type" value="301" <?php print ((isset($_POST['redirect_type']) and $_POST['redirect_type'] == '301')?'checked="true"':''); ?> />&nbsp;Permanent Redirect (301)
