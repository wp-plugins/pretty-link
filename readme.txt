...
1.3.16 - Added Pretty Link Groups

1.3.15 - Performance Enhancements and Bug Fixes

1.3.14 - Big changes to Pretty Link reporting and Bug Fixes.

1.3.13 - Bug Fixes

1.3.12 - Added CSV reports for visitor and IP based reports

1.3.11 - Added visitor tracking to csv download and individual views

1.3.10 - Track users across hits

1.3.9 - Bug Fixes

1.3.8 - Bug Fixes

1.3.7 - Added the ability to select Temporary (307) or Permanent (301) redirection for your Pretty Links

1.3.6 - Added Request URI to the data stream and the ability to search / sort hits
